...
class Dataset:
    ...
    #    self.H = rf.Header(self.fp_path, nested=False)
    #    return self.H
...
class TestHeader:
    ...
    def setup(self, request, tmpdir):
        ...
        self.H = rf.Header(dataset.fp_path)
    ...
    def test_trajectory(self):
        trajectory_path = os.path.join(self.H.fp_path, 'trajectories.txt')
        T = rf.read_trajectories(trajectory_path)
        assert T['numpoint'] == H.numpoint
    # Test FD structures
    #def test_FD(self):

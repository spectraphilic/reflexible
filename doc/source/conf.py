...
copyright = u'2015-2018, John F. Burkhart, Francesc Alted'
...
latex_documents = [
  ('index', 'Reflexible.tex', u'Reflexible Documentation',
   u'John F. Burkhart, Francesc Alted', 'manual'),
]
...
man_pages = [
    ('index', 'reflexible', u'Reflexible Documentation',
     [u'John F. Burkhart, Francesc Alted'], 1)
]
...
texinfo_documents = [
  ('index', 'Reflexible', u'Reflexible Documentation',
   u'John F. Burkhart, Francesc Alted', 'Reflexible', 'One line description of project.',
   'Miscellaneous'),
]

# -*- coding: utf-8 -*-
#
# pflexpart documentation build configuration file, created by
...
sys.path.insert(0, '/home/jfb/workspace')
...
htmlhelp_basename = 'pflexpartdoc'
...
latex_documents = [
  ('index', 'pflexpart.tex', u'pflexpart Documentation',
...
man_pages = [
    ('index', 'pflexpart', u'pflexpart Documentation',
     [u'John F. Burkhart'], 1)
]

/* Generated by Cython 0.12.1 on Thu Jul  8 14:01:08 2010 */
...
#endif
#include <math.h>
#define __PYX_HAVE_API__pflexcy
#include "stdlib.h"
#include "stdio.h"
...
Py_ssize_t __Pyx_zeros[] = {0, 0, 0, 0, 0};
Py_ssize_t __Pyx_minusones[] = {-1, -1, -1, -1, -1};
...
/* Module declarations from pflexcy */
...
#define __Pyx_MODULE_NAME "pflexcy"
int __pyx_module_is_main_pflexcy = 0;

/* Implementation of pflexcy */
...
static char __pyx_k_7[] = "dumpdatagrid (line 4)";
static char __pyx_k_8[] = "dumpdepogrid (line 30)";
...
/* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":4
 * cimport numpy as np
 * 
...
static PyObject *__pyx_pf_7pflexcy_dumpdatagrid(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_7pflexcy_dumpdatagrid[] = " function to dump sparse elementVs into grid ";
static PyObject *__pyx_pf_7pflexcy_dumpdatagrid(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  int __pyx_v_ix;
  float __pyx_v_fact;
  Py_buffer __pyx_bstruct_dmp_r;
  Py_ssize_t __pyx_bstride_0_dmp_r = 0;
  Py_ssize_t __pyx_bshape_0_dmp_r = 0;
  Py_buffer __pyx_bstruct_grd;
  Py_ssize_t __pyx_bstride_0_grd = 0;
  Py_ssize_t __pyx_bstride_1_grd = 0;
  Py_ssize_t __pyx_bstride_2_grd = 0;
  Py_ssize_t __pyx_bstride_3_grd = 0;
  Py_ssize_t __pyx_bstride_4_grd = 0;
  Py_ssize_t __pyx_bshape_0_grd = 0;
  Py_ssize_t __pyx_bshape_1_grd = 0;
  Py_ssize_t __pyx_bshape_2_grd = 0;
  Py_ssize_t __pyx_bshape_3_grd = 0;
  Py_ssize_t __pyx_bshape_4_grd = 0;
  Py_buffer __pyx_bstruct_dmp_i;
  Py_ssize_t __pyx_bstride_0_dmp_i = 0;
  Py_ssize_t __pyx_bshape_0_dmp_i = 0;
  ...
  __Pyx_RefNannySetupContext("dumpdatagrid");
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "dumpdatagrid") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    ...
    __pyx_v_dmp_i = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 0));
    __pyx_v_cnt_r = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 1)); if (unlikely((__pyx_v_cnt_r == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_dmp_r = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 2));
    __pyx_v_grd = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 3));
    __pyx_v_k = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 4)); if (unlikely((__pyx_v_k == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_nage = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 5)); if (unlikely((__pyx_v_nage == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_nx = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 6)); if (unlikely((__pyx_v_nx == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_ny = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 7)); if (unlikely((__pyx_v_ny == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("pflexcy.dumpdatagrid");
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __Pyx_INCREF((PyObject *)__pyx_v_dmp_i);
  __Pyx_INCREF((PyObject *)__pyx_v_dmp_r);
  __Pyx_INCREF((PyObject *)__pyx_v_grd);
  __pyx_bstruct_dmp_i.buf = NULL;
  __pyx_bstruct_dmp_r.buf = NULL;
  __pyx_bstruct_grd.buf = NULL;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_grd), __pyx_ptype_5numpy_ndarray, 1, "grd", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_dmp_i, (PyObject*)__pyx_v_dmp_i, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_dmp_i = __pyx_bstruct_dmp_i.strides[0];
  __pyx_bshape_0_dmp_i = __pyx_bstruct_dmp_i.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_dmp_r, (PyObject*)__pyx_v_dmp_r, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_dmp_r = __pyx_bstruct_dmp_r.strides[0];
  __pyx_bshape_0_dmp_r = __pyx_bstruct_dmp_r.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_grd, (PyObject*)__pyx_v_grd, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 5, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_grd = __pyx_bstruct_grd.strides[0]; __pyx_bstride_1_grd = __pyx_bstruct_grd.strides[1]; __pyx_bstride_2_grd = __pyx_bstruct_grd.strides[2]; __pyx_bstride_3_grd = __pyx_bstruct_grd.strides[3]; __pyx_bstride_4_grd = __pyx_bstruct_grd.strides[4];
  __pyx_bshape_0_grd = __pyx_bstruct_grd.shape[0]; __pyx_bshape_1_grd = __pyx_bstruct_grd.shape[1]; __pyx_bshape_2_grd = __pyx_bstruct_grd.shape[2]; __pyx_bshape_3_grd = __pyx_bstruct_grd.shape[3]; __pyx_bshape_4_grd = __pyx_bstruct_grd.shape[4];

  /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":9
 ...
 */
  ...
  /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":10
 *     cdef float fact
 *     ii=0
 *     fact=1             # <<<<<<<<<<<<<<
 *     pos = 0
 ...
 */
  ...
  /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":11
 *     ii=0
 *     fact=1
 *     pos = 0             # <<<<<<<<<<<<<<
 *     for ir in range(cnt_r):
 ...
 */
  ...
  /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":12
 *     fact=1
 *     pos = 0
 *     for ir in range(cnt_r):             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":14
 *     for ir in range(cnt_r):
 * 
 *         if dmp_r[ir]*fact>0:             # <<<<<<<<<<<<<<
 *             n=dmp_i[ii]
 ...
 */
    ...
    __pyx_t_4 = -1;
    if (__pyx_t_3 < 0) {
      __pyx_t_3 += __pyx_bshape_0_dmp_r;
      if (unlikely(__pyx_t_3 < 0)) __pyx_t_4 = 0;
    } else if (unlikely(__pyx_t_3 >= __pyx_bshape_0_dmp_r)) __pyx_t_4 = 0;
    if (unlikely(__pyx_t_4 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_4);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    __pyx_t_5 = (((*__Pyx_BufPtrStrided1d(float *, __pyx_bstruct_dmp_r.buf, __pyx_t_3, __pyx_bstride_0_dmp_r)) * __pyx_v_fact) > 0);
    if (__pyx_t_5) {

      /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":15
 * 
 *         if dmp_r[ir]*fact>0:
 *             n=dmp_i[ii]             # <<<<<<<<<<<<<<
 *             ii=ii+1
 ...
 */
      ...
      __pyx_t_6 = -1;
      if (__pyx_t_4 < 0) {
        __pyx_t_4 += __pyx_bshape_0_dmp_i;
        if (unlikely(__pyx_t_4 < 0)) __pyx_t_6 = 0;
      } else if (unlikely(__pyx_t_4 >= __pyx_bshape_0_dmp_i)) __pyx_t_6 = 0;
      if (unlikely(__pyx_t_6 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_6);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_v_n = (*__Pyx_BufPtrStrided1d(int *, __pyx_bstruct_dmp_i.buf, __pyx_t_4, __pyx_bstride_0_dmp_i));

      /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":16
 *         if dmp_r[ir]*fact>0:
 *             n=dmp_i[ii]
 *             ii=ii+1             # <<<<<<<<<<<<<<
 *             fact=fact*-1.
 ...
 */
      ...
      /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":17
 *             n=dmp_i[ii]
 *             ii=ii+1
 *             fact=fact*-1.             # <<<<<<<<<<<<<<
 *         else:
 *             n=n+1
 */
      __pyx_v_fact = (__pyx_v_fact * (-1.0));
      goto __pyx_L8;
    }
    /*else*/ {

      /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":19
 *             fact=fact*-1.
 *         else:
 *             n=n+1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":21
 *             n=n+1
 * 
 *         kz=n/(nx*ny)             # <<<<<<<<<<<<<<
 *         jy=(n-kz*nx*ny)/nx
 ...
 */
    ...
    /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":22
 * 
 *         kz=n/(nx*ny)
 *         jy=(n-kz*nx*ny)/nx             # <<<<<<<<<<<<<<
 *         ix=n-nx*ny*kz-nx*jy
 ...
 */
    ...
    /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":23
 *         kz=n/(nx*ny)
 *         jy=(n-kz*nx*ny)/nx
 *         ix=n-nx*ny*kz-nx*jy             # <<<<<<<<<<<<<<
 *         grd[ix,jy,kz-1,k,nage]=abs(dmp_r[ir])
 ...
 */
    ...
    /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":24
 *         jy=(n-kz*nx*ny)/nx
 *         ix=n-nx*ny*kz-nx*jy
 *         grd[ix,jy,kz-1,k,nage]=abs(dmp_r[ir])             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_7 = -1;
    if (__pyx_t_6 < 0) {
      __pyx_t_6 += __pyx_bshape_0_dmp_r;
      if (unlikely(__pyx_t_6 < 0)) __pyx_t_7 = 0;
    } else if (unlikely(__pyx_t_6 >= __pyx_bshape_0_dmp_r)) __pyx_t_7 = 0;
    if (unlikely(__pyx_t_7 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_7);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    __pyx_t_8 = PyFloat_FromDouble((*__Pyx_BufPtrStrided1d(float *, __pyx_bstruct_dmp_r.buf, __pyx_t_6, __pyx_bstride_0_dmp_r))); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_9 = PyNumber_Absolute(__pyx_t_8); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_10 = __pyx_PyFloat_AsDouble(__pyx_t_9); if (unlikely((__pyx_t_10 == (npy_float64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __pyx_t_7 = __pyx_v_ix;
    __pyx_t_11 = __pyx_v_jy;
    __pyx_t_12 = (__pyx_v_kz - 1);
    __pyx_t_13 = __pyx_v_k;
    __pyx_t_14 = __pyx_v_nage;
    __pyx_t_15 = -1;
    if (__pyx_t_7 < 0) {
      __pyx_t_7 += __pyx_bshape_0_grd;
      if (unlikely(__pyx_t_7 < 0)) __pyx_t_15 = 0;
    } else if (unlikely(__pyx_t_7 >= __pyx_bshape_0_grd)) __pyx_t_15 = 0;
    if (__pyx_t_11 < 0) {
      __pyx_t_11 += __pyx_bshape_1_grd;
      if (unlikely(__pyx_t_11 < 0)) __pyx_t_15 = 1;
    } else if (unlikely(__pyx_t_11 >= __pyx_bshape_1_grd)) __pyx_t_15 = 1;
    if (__pyx_t_12 < 0) {
      __pyx_t_12 += __pyx_bshape_2_grd;
      if (unlikely(__pyx_t_12 < 0)) __pyx_t_15 = 2;
    } else if (unlikely(__pyx_t_12 >= __pyx_bshape_2_grd)) __pyx_t_15 = 2;
    if (__pyx_t_13 < 0) {
      __pyx_t_13 += __pyx_bshape_3_grd;
      if (unlikely(__pyx_t_13 < 0)) __pyx_t_15 = 3;
    } else if (unlikely(__pyx_t_13 >= __pyx_bshape_3_grd)) __pyx_t_15 = 3;
    if (__pyx_t_14 < 0) {
      __pyx_t_14 += __pyx_bshape_4_grd;
      if (unlikely(__pyx_t_14 < 0)) __pyx_t_15 = 4;
    } else if (unlikely(__pyx_t_14 >= __pyx_bshape_4_grd)) __pyx_t_15 = 4;
    if (unlikely(__pyx_t_15 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_15);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    *__Pyx_BufPtrStrided5d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_grd.buf, __pyx_t_7, __pyx_bstride_0_grd, __pyx_t_11, __pyx_bstride_1_grd, __pyx_t_12, __pyx_bstride_2_grd, __pyx_t_13, __pyx_bstride_3_grd, __pyx_t_14, __pyx_bstride_4_grd) = __pyx_t_10;
  }

  /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":27
 * 
 * 
 *     return grd             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_dmp_r);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_grd);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_dmp_i);
  ...
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_dmp_i);
  __pyx_L2:;
  __Pyx_DECREF((PyObject *)__pyx_v_dmp_i);
  __Pyx_DECREF((PyObject *)__pyx_v_dmp_r);
  __Pyx_DECREF((PyObject *)__pyx_v_grd);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":30
 * 
 * 
...
static PyObject *__pyx_pf_7pflexcy_dumpdepogrid(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_7pflexcy_dumpdepogrid[] = " function to dump sparse elementVs into grid ";
static PyObject *__pyx_pf_7pflexcy_dumpdepogrid(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_dmp_i = 0;
  int __pyx_v_cnt_r;
  PyArrayObject *__pyx_v_dmp_r = 0;
  PyArrayObject *__pyx_v_grd = 0;
  ...
  int __pyx_t_14;
  static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__dmp_i,&__pyx_n_s__cnt_r,&__pyx_n_s__dmp_r,&__pyx_n_s__grd,&__pyx_n_s__k,&__pyx_n_s__nage,&__pyx_n_s__nx,&__pyx_n_s__ny,0};
  __Pyx_RefNannySetupContext("dumpdepogrid");
  __pyx_self = __pyx_self;
  if (unlikely(__pyx_kwds)) {
    Py_ssize_t kw_args = PyDict_Size(__pyx_kwds);
    PyObject* values[8] = {0,0,0,0,0,0,0,0};
    ...
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "dumpdepogrid") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_dmp_i = ((PyArrayObject *)values[0]);
    ...
    __pyx_v_dmp_i = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 0));
    __pyx_v_cnt_r = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 1)); if (unlikely((__pyx_v_cnt_r == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_dmp_r = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 2));
    __pyx_v_grd = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 3));
    __pyx_v_k = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 4)); if (unlikely((__pyx_v_k == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_nage = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 5)); if (unlikely((__pyx_v_nage == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_nx = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 6)); if (unlikely((__pyx_v_nx == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_ny = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 7)); if (unlikely((__pyx_v_ny == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("pflexcy.dumpdepogrid");
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __Pyx_INCREF((PyObject *)__pyx_v_dmp_i);
  __Pyx_INCREF((PyObject *)__pyx_v_dmp_r);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_dmp_i, (PyObject*)__pyx_v_dmp_i, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_dmp_i = __pyx_bstruct_dmp_i.strides[0];
  __pyx_bshape_0_dmp_i = __pyx_bstruct_dmp_i.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_dmp_r, (PyObject*)__pyx_v_dmp_r, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_dmp_r = __pyx_bstruct_dmp_r.strides[0];
  __pyx_bshape_0_dmp_r = __pyx_bstruct_dmp_r.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_grd, (PyObject*)__pyx_v_grd, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 4, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_grd = __pyx_bstruct_grd.strides[0]; __pyx_bstride_1_grd = __pyx_bstruct_grd.strides[1]; __pyx_bstride_2_grd = __pyx_bstruct_grd.strides[2]; __pyx_bstride_3_grd = __pyx_bstruct_grd.strides[3];
  __pyx_bshape_0_grd = __pyx_bstruct_grd.shape[0]; __pyx_bshape_1_grd = __pyx_bstruct_grd.shape[1]; __pyx_bshape_2_grd = __pyx_bstruct_grd.shape[2]; __pyx_bshape_3_grd = __pyx_bstruct_grd.shape[3];

  /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":35
 *     cdef int ir,ii,pos,n,kz,jy,ix
 *     cdef float fact
 *     ii=0             # <<<<<<<<<<<<<<
 *     fact=1
 ...
 */
  ...
  /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":36
 *     cdef float fact
 *     ii=0
 *     fact=1             # <<<<<<<<<<<<<<
 *     pos = 0
 ...
 */
  ...
  /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":37
 *     ii=0
 *     fact=1
 *     pos = 0             # <<<<<<<<<<<<<<
 *     for ir in range(cnt_r):
 ...
 */
  ...
  /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":38
 *     fact=1
 *     pos = 0
 *     for ir in range(cnt_r):             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":40
 *     for ir in range(cnt_r):
 * 
 *         if dmp_r[ir]*fact>0:             # <<<<<<<<<<<<<<
 *             n=dmp_i[ii]
 ...
 */
    ...
    if (__pyx_t_5) {
      ...
      /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":41
 * 
 *         if dmp_r[ir]*fact>0:
 *             n=dmp_i[ii]             # <<<<<<<<<<<<<<
 *             ii=ii+1
 ...
 */
      ...
      /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":42
 *         if dmp_r[ir]*fact>0:
 *             n=dmp_i[ii]
 *             ii=ii+1             # <<<<<<<<<<<<<<
 *             fact=fact*-1.
 ...
 */
      ...
      /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":43
 *             n=dmp_i[ii]
 *             ii=ii+1
 *             fact=fact*-1.             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":45
 *             fact=fact*-1.
 *         else:
 *             pos=pos+1             # <<<<<<<<<<<<<<
 *         jy=n/nx
 ...
 */
    ...
    /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":46
 *         else:
 *             pos=pos+1
 *         jy=n/nx             # <<<<<<<<<<<<<<
 *         ix=n-nx*jy
 ...
 */
    ...
    /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":47
 *             pos=pos+1
 *         jy=n/nx
 *         ix=n-nx*jy             # <<<<<<<<<<<<<<
 *         grd[ix,jy,k,nage]=abs(dmp_r[ir])
 ...
 */
    ...
    /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":48
 *         jy=n/nx
 *         ix=n-nx*jy
 *         grd[ix,jy,k,nage]=abs(dmp_r[ir])             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_8 = PyFloat_FromDouble((*__Pyx_BufPtrStrided1d(float *, __pyx_bstruct_dmp_r.buf, __pyx_t_6, __pyx_bstride_0_dmp_r))); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_9 = PyNumber_Absolute(__pyx_t_8); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_10 = __pyx_PyFloat_AsDouble(__pyx_t_9); if (unlikely((__pyx_t_10 == (npy_float64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __pyx_t_7 = __pyx_v_ix;
    __pyx_t_11 = __pyx_v_jy;
    __pyx_t_12 = __pyx_v_k;
    __pyx_t_13 = __pyx_v_nage;
    __pyx_t_14 = -1;
    if (__pyx_t_7 < 0) {
      __pyx_t_7 += __pyx_bshape_0_grd;
      if (unlikely(__pyx_t_7 < 0)) __pyx_t_14 = 0;
    } else if (unlikely(__pyx_t_7 >= __pyx_bshape_0_grd)) __pyx_t_14 = 0;
    if (__pyx_t_11 < 0) {
      __pyx_t_11 += __pyx_bshape_1_grd;
      if (unlikely(__pyx_t_11 < 0)) __pyx_t_14 = 1;
    } else if (unlikely(__pyx_t_11 >= __pyx_bshape_1_grd)) __pyx_t_14 = 1;
    if (__pyx_t_12 < 0) {
      __pyx_t_12 += __pyx_bshape_2_grd;
      if (unlikely(__pyx_t_12 < 0)) __pyx_t_14 = 2;
    } else if (unlikely(__pyx_t_12 >= __pyx_bshape_2_grd)) __pyx_t_14 = 2;
    if (__pyx_t_13 < 0) {
      __pyx_t_13 += __pyx_bshape_3_grd;
      if (unlikely(__pyx_t_13 < 0)) __pyx_t_14 = 3;
    } else if (unlikely(__pyx_t_13 >= __pyx_bshape_3_grd)) __pyx_t_14 = 3;
    if (unlikely(__pyx_t_14 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_14);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    *__Pyx_BufPtrStrided4d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_grd.buf, __pyx_t_7, __pyx_bstride_0_grd, __pyx_t_11, __pyx_bstride_1_grd, __pyx_t_12, __pyx_bstride_2_grd, __pyx_t_13, __pyx_bstride_3_grd) = __pyx_t_10;
  }

  /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":50
 *         grd[ix,jy,k,nage]=abs(dmp_r[ir])
 * 
 *     return grd #flipud(grd.transpose())             # <<<<<<<<<<<<<<
 * 
...
static struct PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("dumpdatagrid"), (PyCFunction)__pyx_pf_7pflexcy_dumpdatagrid, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_7pflexcy_dumpdatagrid)},
  {__Pyx_NAMESTR("dumpdepogrid"), (PyCFunction)__pyx_pf_7pflexcy_dumpdepogrid, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_7pflexcy_dumpdepogrid)},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  __pyx_refnanny = __Pyx_RefNanny->SetupContext("PyMODINIT_FUNC PyInit_pflexcy(void)", __LINE__, __FILE__);
  #endif
  ...
  if (__pyx_module_is_main_pflexcy) {
  ...
  /* "/flex_wrk/jfb/jfburkhart/pflexcy.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * 
 */
 ...
 * 
 */
  __pyx_t_2 = PyObject_GetAttr(__pyx_m, __pyx_n_s__dumpdatagrid); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyObject_GetAttr(__pyx_m, __pyx_n_s__dumpdepogrid); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  if (__pyx_m) {
    __Pyx_AddTraceback("init pflexcy");
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pflexcy");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
